...
const About: React.FC = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-32 lg:py-64 bg-[#050505]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-7 lg:pt-24 reveal delay-200">
            <div className="mb-12 inline-flex items-center space-x-4">
                <span className="text-white/30 uppercase tracking-[0.5em] text-[9px] font-bold">Our Philosophy</span>
            ...
            <div className="max-w-xl space-y-10 text-white/60 text-base md:text-lg leading-relaxed font-light">
              <p>
              ...
              <div className="pt-8 border-t border-white/10 grid grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-xs font-light text-white/40 leading-relaxed">Safety is not a checklist; it is an instinct honed through thousands of shared kilometers.</p>
                </div>
                <div>
                  <h4 className="text-white text-[10px] uppercase tracking-[0.3em] font-bold mb-3">Loyalty</h4>
                  <p className="text-xs font-light text-white/40 leading-relaxed">No rider is left behind. We are bound by a commitment that remains silent but absolute.</p>
                </div>
              </div>
            </div>
          </div>
