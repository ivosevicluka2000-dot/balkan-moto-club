    ...
    <section id="join" className="relative py-32 lg:py-80 overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div className="mb-12 flex justify-center items-center space-x-6">
            ...
            <span className="text-white/50 uppercase tracking-[0.5em] text-[10px] font-bold">Initiation Registry</span>
            <div className="w-12 h-px bg-white/30" />
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <p className="text-white/70 text-lg md:text-xl mb-16 font-light leading-relaxed tracking-wide">
          ...
          <div className="flex flex-col items-center">
            <button className="group relative px-16 py-5 bg-white text-black text-xs font-bold uppercase tracking-[0.4em] hover:scale-105 transition-all duration-300 active:scale-95 shadow-lg shadow-white/10">
              Request Vetting
            </button>
          ...
          <div className="mt-20 grid grid-cols-3 gap-8 opacity-40">
             <div className="flex flex-col items-center space-y-4">
                ...
                <span className="text-[10px] uppercase tracking-widest">Strength</span>
             </div>
             <div className="flex flex-col items-center space-y-4">
                <div className="w-12 h-12 border border-white/60 flex items-center justify-center">
                    <span className="text-xs font-bold">H</span>
                </div>
                <span className="text-[10px] uppercase tracking-widest">Honor</span>
             </div>
             <div className="flex flex-col items-center space-y-4">
                <div className="w-12 h-12 border border-white/60 flex items-center justify-center">
                    <span className="text-xs font-bold">F</span>
                </div>
                <span className="text-[10px] uppercase tracking-widest">Faith</span>
             </div>
          </div>
        </div>
      </div>
